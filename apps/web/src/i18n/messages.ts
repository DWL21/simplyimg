...
const localeMessages: Record<'ko' | 'en', LocaleMessages> = {
  ko: {
    ...
    home: {
      ...
      currentFeaturesValue: '이미지 압축, 이미지 크기 조절, JPG 변환',
    ...
    tools: {
      compress: {
        ...
        details: '품질 조절, 출력 포맷 선택, 일괄 다운로드',
      ...
      convert: {
        name: 'JPG로 변환',
        label: 'JPG',
        description: 'PNG, WEBP 등 다양한 이미지를 JPG로 정리합니다.',
        details: 'JPG 일괄 변환, 품질 조절, ZIP 다운로드',
        workspaceTitle: 'JPG로 변환',
        workspaceDescription: '다양한 형식의 이미지를 JPG로 통일해서 정리하고 내보냅니다.',
        processLabel: 'JPG로 변환',
      },
    },
    dropzone: {
    ...
    options: {
      ...
      convert: {
        outputTitle: '출력 형식',
        outputDescription: '업로드한 이미지는 모두 JPG로 변환됩니다.',
        input: 'INPUT',
        output: 'OUTPUT',
        qualityTitle: 'JPG 품질',
  ...
  en: {
    ...
    home: {
      ...
      currentFeaturesValue: 'Compress, Resize, Convert to JPG',
    ...
    tools: {
      compress: {
        ...
        details: 'Quality control, output format, ZIP download',
      ...
      convert: {
        name: 'Convert to JPG',
        label: 'JPG',
        description: 'Turn PNG, WEBP, and other formats into JPG files.',
        details: 'Bulk JPG conversion, quality control, ZIP download',
        workspaceTitle: 'Convert to JPG',
        workspaceDescription: 'Convert uploaded images to JPG and export them in a clean batch.',
    ...
    options: {
      ...
      convert: {
        ...
        outputDescription: 'All uploaded images will be converted to JPG.',
        input: 'INPUT',
        output: 'OUTPUT',
